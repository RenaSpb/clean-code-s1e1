...
var editTask = function () {
  ...
  var containsClass = listItem.classList.contains("task_type_edit");
  //If class of the parent is .task_type_edit
  if (containsClass) {
    //switch to .task_type_edit
  ...
  //toggle .task_type_edit on the parent.
  listItem.classList.toggle("task_type_edit");
};
